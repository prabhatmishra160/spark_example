...
object stream_running_total extends App {
...
val read_order = spark.sql("select count(*) from orders where order_status = 'COMPLETE'")


    
val word_count = read_order.writeStream.format("console").outputMode("complete")

.option("checkpointLocation","C:/Users/prabh/Desktop/prabhat4")
